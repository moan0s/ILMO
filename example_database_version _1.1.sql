...
INSERT INTO `lib_books` (`book_ID`, `title`, `author`, `location`, `lend`) VALUES
('S1 a', 'Samplebook', 'Sampleauthor', 'Whereever', 0),
('S1 b', 'Samplebook', 'Sampleauthor', 'IAJFLJ', 1);
...
(2, '44d9dbb60b6c2c24922cd62d249412f9', 'Cooper', 'Sheldon', 'sheldon@cooper.com', 'german', 0);
...
--
ALTER TABLE `lib_lend`
  MODIFY `lend_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
