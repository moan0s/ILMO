...
define ("CHANGED_LANGUAGE_TO", "Changed language to");
...
define ("GIVE_VALID_E_MAIL_ADRESS", "Please enter a valid e-mail adress.<br>");
define ("E_MAIL_ALREADY_IN_USE", "This e-mail adress is already in use. Please log into your already existing account or register with annother e-mail adress.<br>");
define ("PASSWORD_TO_SHORT", "Your choosen password is to short. Please enter a password with four ore more letters.<br>");
...
define ("ENTER_USER_IDENTIFICATION", "Please enter your user-ID or e-mail-adress");
define ("ENTER_PASSWORD", "Pleas enter a password");
define ("WRONG_LOGIN", "The user-ID/e-mail or your password is wrong.");
define ("PLEASE_GIVE_TYPE", "Please give a type");

define ("W_DAY", "Day");
define ("W_START", "Start");
define ("W_END", "End");
define ("W_NOTICE", "Notice");
